...
import { Eye, EyeOff, Lock, Key, Mail, ArrowLeft } from "lucide-react";
...
const ResetPassword = () => {
  ...
  useEffect(() => {
    // Si hay un token en la URL, lo establecemos automáticamente
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.response?.data?.message || "Error al cambiar la contraseña. Verifica que el token y email sean válidos.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          <div className="w-full max-w-md mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-black mb-2">¡Contraseña Actualizada!</h1>
      ...
      <div className="flex-1 px-6 pb-6">
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Ingresa tu email, el token que recibiste por correo y tu nueva contraseña</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="relative">
                <Mail className="absolute left-0 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                <Input
                  type="email"
            ...
            <div className="space-y-2">
              <div className="relative">
                <Key className="absolute left-0 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                <Input
                  type="text"
